...
function runProcess(name, command, args, cwd) {
    ...
    // On Windows, npm is a batch file usually, need shell: true or correct executable
...
// 4. Start Frontend
// We need to pass --host to expose it. npm run dev -- --host
...
console.log('---------------------------------------------------');
console.log(`👉 Access on this machine: http://localhost:5173`);
console.log(`👉 Access on Mobile (QR):  http://${IP}:5173`);
console.log('---------------------------------------------------');
